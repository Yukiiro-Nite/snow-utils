...
public class GoldSnowGolemEntity extends SnowGolemEntity {
  protected static final ItemStack snowballType = new ItemStack(RegistryHandler.GOLD_SNOWBALL.get());

  public GoldSnowGolemEntity(EntityType<? extends SnowGolemEntity> type, World worldIn) {
    super(type, worldIn);
  }

  public void attackEntityWithRangedAttack(LivingEntity target, float distanceFactor) {
    SnowballEntity snowballEntity = new LoadedSnowballEntity(this.world, this, SnowballDamage.GOLD);
