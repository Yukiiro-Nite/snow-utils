...
public class NetheriteSnowGolemEntity extends SnowGolemEntity {
  protected static final ItemStack snowballType = new ItemStack(RegistryHandler.NETHERITE_SNOWBALL.get());

  public NetheriteSnowGolemEntity(EntityType<? extends SnowGolemEntity> type, World worldIn) {
    super(type, worldIn);
  }

  public void attackEntityWithRangedAttack(LivingEntity target, float distanceFactor) {
    SnowballEntity snowballEntity = new LoadedSnowballEntity(this.world, this, SnowballDamage.NETHERITE);
