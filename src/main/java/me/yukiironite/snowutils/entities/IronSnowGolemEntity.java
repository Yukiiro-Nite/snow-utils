...
public class IronSnowGolemEntity extends SnowGolemEntity {
  protected static final ItemStack snowballType = new ItemStack(RegistryHandler.IRON_SNOWBALL.get());

  public IronSnowGolemEntity(EntityType<? extends SnowGolemEntity> type, World worldIn) {
    super(type, worldIn);
  }

  public void attackEntityWithRangedAttack(LivingEntity target, float distanceFactor) {
    SnowballEntity snowballEntity = new LoadedSnowballEntity(this.world, this, SnowballDamage.IRON);
